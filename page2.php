...
<div class="site-main">
    <div class="inner clearfix">
        ...
        <div class="comments clearfix">
            <h4 class="comments-title">Retail rating</h4>
            <div class="comments-fields clearfix">
                <form role="form" action="page2.php" method="post">
					<p>brand</p><input name="brand_name" type="text" placeholder="brand name" required>
					<p>material</p><input name="material_name" type="text" placeholder="material name" required>
					<p>fully fashioned</p><input name="fully_fashioned" type="text" placeholder="fully functioned" required>
    	...
    	<div class="post gallery-post">
            ...
            <?php
				if(isset($_POST['brand_name']) || isset($_POST['material_name']) || isset($_POST['fully_fashioned'])){
					$sql = "select * from material_info where brand = '" . $_POST['brand_name'] . "' || material_name = '". $_POST['fully_fashioned'] . "' || fully_fashioned = '" . $_POST['fully_fashioned'] . "';";
